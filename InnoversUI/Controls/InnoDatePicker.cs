...
namespace InnoversUI.Controls
{
    ...
    ///
    ///     <MyNamespace:InnoDatePicker/>
    ///
    /// </summary>
    public class InnoDatePicker : Control
    {
        static InnoDatePicker()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(InnoDatePicker), new FrameworkPropertyMetadata(typeof(InnoDatePicker)));
        }
    }
}
